...
import com.example.inmyfridge.hashTag.domain.CookingToolTag;
import com.example.inmyfridge.hashTag.domain.IngredientTag;
...
public class RecipePost {
    ...
    @OneToMany
    private List<CookingToolTag> cookingToolTags;
